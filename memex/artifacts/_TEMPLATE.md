...
- **Sibling repo**: `code2/learnhub/docs/something.md` — for living codebases. Use repo-relative paths.
...
```
memex/vault/
  mathematics/    ← papers, LaTeX sources, proofs
  policy/         ← civic documents, policy drafts
  research/       ← notebooks, brainstorms, misc reference material
```
